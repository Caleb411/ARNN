...
if __name__ == '__main__':
    ...
    # 加载模型
    model = load_model("cnn_rnn_ar.h5")
    ...
    plt.plot(range(250), test_y[200:450], label='data')
    plt.plot(range(250), test_predict[200:450], label='forecast', linestyle='--')
    plt.axis([0, 250, 20, 32])
